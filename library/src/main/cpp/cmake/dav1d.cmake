...
ExternalProject_Add(ep_dav1d
    ...
    GIT_TAG 1.5.4
    GIT_SHALLOW TRUE
    CONFIGURE_COMMAND ${CMAKE_COMMAND} -E env "MSYS_NO_PATHCONV=1" "NINJA=${Ninja_EXECUTABLE}" ${Meson_EXECUTABLE} $<$<BOOL:${MESON_VIA_WSL}>:${MESON_WSL_CMD}> setup ${EP_MESON_ARGS} <BINARY_DIR> <SOURCE_DIR>
