...
ExternalProject_Add(ep_libiconv
    ...
    LOG_INSTALL 1
    PATCH_COMMAND
        "${BASH_EXECUTABLE}" -c "sed -i -e 's/#if HAVE_LANGINFO_CODESET/#if 0 \\/\\/ patched for Android/' libcharset/lib/localcharset.c 2>/dev/null || sed -i -e 's/#if HAVE_LANGINFO_CODESET/#if 0/' lib/localcharset.c 2>/dev/null || true; echo \"patched localcharset.c\""
    CONFIGURE_COMMAND
