...
ExternalProject_Add(ep_libiconv
    ...
    LOG_INSTALL 1
    PATCH_COMMAND
        "${BASH_EXECUTABLE}" -c "sed -i -e 's/codeset = nl_langinfo (CODESET)/codeset = \"UTF-8\"/' libcharset/lib/localcharset.c 2>/dev/null || sed -i -e 's/codeset = nl_langinfo (CODESET)/codeset = \"UTF-8\"/' lib/localcharset.c 2>/dev/null || true && sed -i -e 's/#if HAVE_LANGINFO_CODESET/#if 0/' libcharset/lib/localcharset.c 2>/dev/null || sed -i -e 's/#if HAVE_LANGINFO_CODESET/#if 0/' lib/localcharset.c 2>/dev/null || true && (grep -q 'ifndef F_SETFD' srclib/fcntl.c 2>/dev/null || (echo '#ifndef F_SETFD' && echo '#define F_SETFD 2' && echo '#endif' | cat - srclib/fcntl.c > srclib/fcntl.c.tmp && mv srclib/fcntl.c.tmp srclib/fcntl.c && echo patched-fcntl) 2>/dev/null || true) && echo patched-done"
    CONFIGURE_COMMAND
