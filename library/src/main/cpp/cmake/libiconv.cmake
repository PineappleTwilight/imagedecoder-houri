...
ExternalProject_Add(ep_libiconv
    ...
    CONFIGURE_COMMAND
        "${BASH_EXECUTABLE}" -c
        "set -ex; echo libiconv: cygpath check; if command -v cygpath >/dev/null 2>&1; then src=$(cygpath -u \"<SOURCE_DIR>\"); else src=\"<SOURCE_DIR>\"; fi; echo libiconv src=\$src; cd \"$src\" && ./configure ${EP_AUTOTOOLS_ARGS_STR} --enable-extra-encodings"
